...
//				player.sendMessage("Du hast gedrückt");
		...
		this.addOption(4, 0, new Button_with_no_task(itemstack_to_be_added, Message_Handler.resolve_to_message(44, shop.shopname), Message_Handler.resolve_to_message(45)));

		// Hinzufügen

		this.addOption(3, 2, new Button_Confrim_add_Item(shop, itemstack_to_be_added, Material.WOOL, (short)  5, Message_Handler.resolve_to_message(46), ""));

		// Verkaufen
//		this.addOption(5, 2, new SellOption(false, 1, itemstack_to_be_added.getType()).setType(Material.getMaterial(51)));

		
		this.addOption(5, 2, new Button(Material.WOOL, (short) 14, Message_Handler.resolve_to_message(47), "") {
