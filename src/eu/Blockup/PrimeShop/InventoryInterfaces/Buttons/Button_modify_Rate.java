...
//			this.setName(offset_to_String(this.offset));
		...
		public Button_modify_Rate(Shop_Item sqlItem, double offset, Material display_Material, short damage, String name, String... description) {
...
//				if (type == ClickType.LEFT) {
			ReturnBoolean result = new ReturnBoolean();
					...
					player.sendMessage(Message_Handler.resolve_to_message(23, rate_of_price_change));
