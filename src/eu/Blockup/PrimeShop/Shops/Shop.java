...
public class Shop {
	...
	public void refresh_pageCount() {
		...
		if (listsize > 0) {
			double exact_number_of_pages = (double) listsize / Page.amount_of_items_fitting__in_one_page;
	...
	public Page get_Page(int pagenumber) {
		...
		while ((added_items <= Page.amount_of_items_fitting__in_one_page) && (current_position <= this_list_of_Items_Size -1)) {
