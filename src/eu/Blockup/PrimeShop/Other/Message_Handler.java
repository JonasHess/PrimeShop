...
public class Message_Handler {
    ...
    private static String resolve_to_message(int id, String arg0, String arg1, String arg2, String arg3) {
        ...
        result = result.replaceAll(Pattern.quote("UniQue1"), Matcher.quoteReplacement(arg0));
        result = result.replaceAll(Pattern.quote("UniQue2"), Matcher.quoteReplacement(arg1));
        result = result.replaceAll(Pattern.quote("UniQue3"), Matcher.quoteReplacement(arg2));
        result = result.replaceAll(Pattern.quote("UniQue4"), Matcher.quoteReplacement(arg3));
